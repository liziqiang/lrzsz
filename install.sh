...
curl -sSL https://github.com/liziqiang/iterm2-zmodem/raw/master/iterm2-recv-zmodem.sh -o "$recv"
curl -sSL https://github.com/liziqiang/iterm2-zmodem/raw/master/iterm2-send-zmodem.sh -o "$send"
